...
//Remark: To select 2 vectors on the basis of the lower fitness value (shorter path of the salesman) we generate a number with exponential distribution to sum to the minimu fitness value. Then we choose the vector which contains the nearest value to that coming from the sum.
...
int main (int argc, char *argv[]){
    ...
    //We put the points on the unitary circumference
    double angle=0;
    for(int i=0;i<N;i++){
